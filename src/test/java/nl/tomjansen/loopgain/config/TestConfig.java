...
public class TestConfig {
    @MockBean public UserRepository userRepository;
    @MockBean public JwtService jwtService;
    @MockBean public CustomUserDetailsService customUserDetailsService;
    @MockBean public JwtRequestFilter jwtRequestFilter;
}
